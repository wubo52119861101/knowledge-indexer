...
from app.schemas.job import CancelJobRequest, JobItem
from app.services.job_service import JobCancellationConflictError
...
async def cancel_job(
    ...
    try:
        job = container.job_service.request_cancel(job_id, operator=payload.operator, reason=payload.reason)
